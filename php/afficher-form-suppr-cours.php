                                    ...
                                    <tbody>
                                        <?php foreach($datas as $data) : ?>
                                            <tr>
                                                ...
                                                <td><?= $data['Filiere'] ?></td>
                                                <td><?= $data['Niveau'] ?></td>
                                                <td><?= $data['Session_cours'] ?></td>
                                                <td><?= $data['Coefficient'] ?></td>
                                                <td><?= $data['Professeur_titulaire'] ?></td>
                                                <td><?= $data['Professeur_suppleant'] ?></td>
                                                <td><?= $data['Jours'] ?></td>
                                                <td><?= $data['Heure_debut'] ?></td>
                                                <td><?= $data['Heure_Fin'] ?></td>
                                                <td><?= $data['Etat'] ?></td>
                                                <td>
                                                <a href="AllAction/action-suppr-cours.php?id=<?=$data['id']?>"><button>Delete</i></button></a>
                                                </td>
