                    ...
                    <div class="contact-from mt-30">
                        <div class="main-form pt-45">
                            <div class="data-box" id="body-form-aca">
                                ...
                                <form action="AllAction/Enregistrer-form-notes.php" method="post">
                                    <!-- permet de formater chaque input -->
                                    <input name="Id_notes" type="hidden" placeholder="Id notes">
                                    <div class="field-box">
                                        <!-- <input type="text" name="Id_Etudiant" required=""> -->
                                        <label>ID ETUDIANT</label>
                                        </br></br>
                                        <select name="Id_Etudiant" id="Id_Etudiant">
                                            <?php foreach($datas as $data) : ?>
                                                <option value="<?=$data['Id_Etudiant']?>"><?= $data['Id_Etudiant'] ?></option>
                                    ...
                                    <div class="field-box">
                                        ...
                                        <select name="Id_Cours" id="Id_Cours">
                                            <?php foreach($datasT as $data) : ?>
                                                <option value="<?=$data['Id_Cours']?>"><?= $data['Id_Cours'] ?></option>
                                    ...
                                    <div class="field-box">
                                        <input type="text" maxlenght="6" min=0 max=100 pattern="[0-9.]{1,3}" title="Caractere acceptes:[0-9.]" name="Note" data-error="La notes est obligatoire." required="">
                                        <label>NOTES</label>
                                    </div>
                                    <div class="field-box">
                                        <!-- <input type="text" name="AnneeAcademique" required=""> -->
                                    ...
                                    <div class="field-box">
                                        <label>SESSION DE NOTES</label>
                                        </br>
                                        </br>
                                        <select name="Session_notes" id="Session_notes">
