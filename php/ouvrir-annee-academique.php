                    ...
                    <div class="contact-from mt-30">
                        <div class="main-form pt-45">
                            <div class="data-box" id="body-form-aca">
                                ...
                                <form action="AllAction/Enregistrer-form-annee.php" method="post">
                                    <!-- permet de formater chaque input -->
                                  <div class="field-box">
                                    <input type="text" name="Annee_debut" min="1900" maxlenght="4" required pattern="^[0-9]{4,4}$" title="Caractere acceptes:[0-9]">
                                    <label>Annee debut</label>
                                  </div>
                                  <div class="field-box">
                                    <input type="text" name="Annee_fin" min="1900" maxlenght="4"  pattern="[0-9]{4,4}" title="Caractere acceptes:[0-9]" required="" disabled>
                                  ...
                                  <div class="field-box">
                                    <input type="text" name="AnneeAcademique" required="" disabled>
                                    <label>Annee academique</label>
                                  </div>
                                  <div class="field-box">
                                      <label>Statut annee</label>
                                      </br>
                                      </br>
