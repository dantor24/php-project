...
if(isset($_POST['submit'])){
   ...
   if(empty($errors)){
        $queryPrepare=$pdo->prepare("UPDATE cours SET Nom_cours=:Nom_cours,Filiere=:Filiere,Niveau=:Niveau,Session_cours=:Session_cours,Coefficient=:Coefficient,Professeur_titulaire=:Professeur_titulaire,Professeur_suppleant=:Professeur_suppleant,Jours=:Jours,Heure_debut=:Heure_debut,Heure_Fin=:Heure_Fin,Etat=:Etat WHERE id=:id");
