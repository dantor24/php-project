...
if(isset($_POST['submit'])){
   ...
   if(empty($errors)){
        $queryPrepare=$pdo->prepare("INSERT INTO dossierprof(Code, Nom, Prenom, Sexe, Adresse, Telephone, Statut_Matrimonial, Lieu_de_naissance, Date_de_naissance, Niveau, Cours_a_enseigner, Filieres_affectes, Salaire, Poste, Email, Nif_Cin, Etat, Memo) VALUES (:Code,:Nom,:Prenom,:Sexe,:Adresse,:Telephone,:Statut_Matrimonial,:Lieu_de_naissance,:Date_de_naissance,:Niveau,:Cours_a_enseigner,:Filieres_affectes,:Salaire,:Poste,:Email,:Nif_Cin,:Etat,:Memo)");
