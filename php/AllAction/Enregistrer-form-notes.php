...
if(isset($_POST['submit'])){
   ...
   if(empty($errors)){
        $queryPrepare=$pdo->prepare("INSERT INTO Notes(Id_Etudiant, Id_Cours, Note, AnneeAcademique, Session_notes) VALUES (:Id_Etudiant,:Id_Cours,:Note,:AnneeAcademique,:Session_notes)");
    ...
    header('Location:../errors/errors-server.php');
   }
