                            ...
                            <nav class="navbar navbar-expand-lg">
                                ...
                                <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                    <ul class="navbar-nav mr-auto">
                                        ...
                                        <li class="nav-item">
                                            <a class="active" href="palmares.php">PALMARES</a>
                                            <ul class="sub-menu">
                                    ...
                                    <tbody>
                                        <?php foreach($datas as $data) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                <a href="bulletins.php?id=<?=$data['id']?>"><button>Bulletin</i></button></a>
                                                <a href="reveles-de-note.php?id=<?=$data['id']?>"><button>Releve de note</i></button></a>
                                                </td>                                          
                                            </tr>
                                            <?php endforeach ; ?>
