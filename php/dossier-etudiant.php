            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-banner-cont">
                        <h2>DOSSIER DES ETUDIANTS </h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#">Gestion dossier des étudiants</a></li>
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="section-title mt-50 pb-35">
                        <h5>GESTION DES DOSSIER DES ETUDIANTS</h5>
                        <p>Ce module permet de gérer les dossiers des étudiants. Il contient
           ...
           <div class="row">
               <div class="col-lg-3 col-sm-6">
                   <div class="singel-teachers mt-30 text-center">
                        <div class="image">
                            <a href="../enregistrer-etudiants.php"><img src="../images/teachers/aca5.jpg" alt="Teachers"></a>
                        </div>
                        <div class="cont">
                            <a href="enregister-formeEtudiantiant.php"><h6>ENREGISTRER LES ETUDIANTS</h6></a>
                        </div>
                    </div> <!-- singel teachers -->
               </div>
               <div class="col-lg-3 col-sm-6">
                   <div class="singel-teachers mt-30 text-center">
                        ...
                        <div class="cont">
                            <a href="Afficher-Etudiant.php"><h6>AFFICHER LES ETUDIANTS</h6></a>
                        </div>
                    </div> <!-- singel teachers -->
               </div>
               <div class="col-lg-3 col-sm-6">
                   <div class="singel-teachers mt-30 text-center">
                        ...
                        <div class="cont">
                            <a href="modifier-Etudiant.php"><h6>MODIFIER LES ETUDIANTS</h6></a>
                        </div>
                    </div> <!-- singel teachers -->
               </div>
               <div class="col-lg-3 col-sm-6">
                   <div class="singel-teachers mt-30 text-center">
                        ...
                        <div class="cont">
                            <a href="afficher_for_delete_Etudiant.php"><h6>SUPPRIMER LES ETUDIANTS</h6></a>
                        </div>
                    </div> <!-- singel teachers -->
               </div>
               <div class="col-lg-3 col-sm-6">
                   <div class="singel-teachers mt-30 text-center">
                        ...
                        <div class="cont">
                            <a href="#"><h6>IMPRIMER LA LISTE DES ETUDIANTS</h6></a>
                        </div>
                    </div> <!-- singel teachers -->
               </div>
               <div class="col-lg-3 col-sm-6">
                <div class="singel-teachers mt-30 text-center">
                     ...
                     <div class="cont">
                         <a href="#"><h6>ENREGISTRER A PARTIR D'UN FICHIER TEXTE</h6></a>
                     </div>
                 </div> <!-- singel teachers -->
            </div>
           </div> <!-- row -->
