            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="section-title mt-50 pb-35">
                        ...
                        <p>Ce module permet de gérer les utilisateurs. Il contient
           ...
           <div class="row">
               <div class="col-lg-3 col-sm-6">
                   <div class="singel-teachers mt-30 text-center">
                        ...
                        <div class="cont">
                            <a href="form_enregister_Utilisateur.php"><h6>ENREGISTRER LES UTILISATEURS</h6></a>
                        </div>
                    </div> <!-- singel teachers -->
               </div>
               <div class="col-lg-3 col-sm-6">
                   <div class="singel-teachers mt-30 text-center">
                        ...
                        <div class="cont">
                            <a href="afficher-Utilisateurs.php"><h6>AFFICHER LES UTILISATEURS</h6></a>
                        </div>
                    </div> <!-- singel teachers -->
               </div>
               <div class="col-lg-3 col-sm-6">
                   <div class="singel-teachers mt-30 text-center">
                        ...
                        <div class="cont">
                            <a href="afficher-modifier-utilisateur.php"><h6>MODIFIER LES UTILISATEURS</h6></a>
                        </div>
                    </div> <!-- singel teachers -->
               </div>
               <div class="col-lg-3 col-sm-6">
                   <div class="singel-teachers mt-30 text-center">
                        ...
                        <div class="cont">
                            <a href="affichage_for_delete_Utiliateur.php"><h6>SUPPRIMER LES UTILISATEURS</h6></a>
                        </div>
                    </div> <!-- singel teachers -->
               </div>
               <div class="col-lg-3 col-sm-6">
                   <div class="singel-teachers mt-30 text-center">
                        ...
                        <div class="cont">
                            <a href="rechercher-utilisateur.php"><h6>RECHERCHER LES UTILISATEURS</h6></a>
                        </div>
                    </div> <!-- singel teachers -->
               </div>
               </div> <!-- row -->
