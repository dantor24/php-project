...
<head>
    ...
    <link href="../css/styleTableau.css" rel="stylesheet">
         ...
         <!-- <div class="container"> -->
                                    ...
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <th>Niveau</th>
                                            <th>Nif/Cin</th>
                                            <th>Personne de Ref.</th>
                                            <th>Tel Per de Ref.</th>
                                            <th>Photo</th>
                                    ...
                                    <tbody>
                                        <?php while($et=$ps->fetch()) { ?>
                                            <tr>
                                                ...
                                                <td><?php echo($et['Date_de_naissance'])?></td>
                                                <td><?php echo($et['Telephone'])?></td>
                                                <td><?php echo($et['Email'])?></td>
                                                <td><?php echo($et['Filiere'])?></td>
                                                <td><?php echo($et['Niveau'])?></td>
                                                <td><?php echo($et['Nif_Cin'])?></td>
                                                <td><?php echo($et['Personne_de_reference'])?></td>
                                                <td><?php echo($et['Telephone_personne_reference'])?></td>
                                                <td><img src="AllAction/images/<?php echo($et['Photo'])?>" width="100" height="50"></td>
                                                <td><?php echo($et['Annee_Academique'])?></td>
