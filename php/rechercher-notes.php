                    ...
                    <div class="contact-from mt-30">
                        <div class="main-form pt-45">
                            <div class="data-box" id="body-form-aca">
                                <form action="Action-rechercher-notes.php" method="post">
                                    <div class="col-md-6">
                                        <div class="singel-form form-group" position="center">
                                            <label for=""> Entrer l'identifiant de la note </label>
                                            <br></br>
                                            <input name="Id_notes" type="text" maxlenght="10" pattern="[a-zA-Z1-9 ]{1,10}" title="Caractere acceptes:[a-zA-Z]" placeholder="id notes" data-error="l'identifiant est obligatoire." required="required">
