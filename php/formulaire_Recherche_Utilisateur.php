            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="slider-cont-3 text-center">
                        <h2>Recherchés les Utilisateurs du systeme de CHC-UEHL</h2>
                        <span>Identifiant Obligatoire. </span>
                        <div class="slider-search mt-45">
                           <form action="#">
                                <div class="row no-gutters">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="Id_Utilisateur" placeholder="Search User the Chcl">
                                    </div>
                                    <div class="col-sm-3">
                                        <button type="button" name="Boutton" class="main-btn">rechercher maintenant</button>
                                    </div>
                                </div> <!-- row -->
                            </form>
                        </div>
