                                    ...
                                    <tbody>
                                        <?php foreach($datas as $data) : ?>
                                            <tr>
                                                ...
                                                <td><?= $data['Niveau'] ?></td>
                                                <td><?= $data['Nif_Cin'] ?></td>
                                                <td><?= $data['Personne_de_reference'] ?></td>
                                                <td><?= $data['Telephone_personne_reference'] ?></td>
                                                <td><?= $data['Photo'] ?></td>
                                                <td><?= $data['Annee_Academique'] ?></td>
                                                <td><?= $data['Etat'] ?></td>
                                                <td><?= $data['Memo'] ?></td>
                                                <td>
                                                <a href="Allaction/action_supprimer_Etudiant.php?id=<?=$data['id']?>"><button>Supprimer</i></button></a>
                                                </td>                                          
                                            </tr>
                                            <?php endforeach ; ?>
