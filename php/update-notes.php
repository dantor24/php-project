...
if(isset($_GET['Id_notes'])){
    $Id_notes = htmlentities(htmlspecialchars($_GET['Id_notes']));
    $queryPrepare=$pdo->prepare("SELECT * FROM Notes WHERE Id_notes=:Id_notes"); 
                    ...
                    <div class="contact-from mt-30">
                        <div class="main-form pt-45">
                            <div class="data-box" id="body-form-aca">
                                ...
                                <form action="AllAction/action-modifier-notes.php" method="post">
                                    <!-- permet de formater chaque input -->
                                    <input name="Id_notes" type="hidden" value="<?= $data['Id_notes']?>">
                                    <div class="field-box">
                                        <input type="text" name="Id_Etudiant" value="<?= $data['Id_Etudiant']?>" required="">
                                        <label>Id Etudiant</label>
                                    </div>
                                    <div class="field-box">
                                        <input type="text" name="Id_Cours" value="<?= $data['Id_Cours']?>" required="">
                                        <label>Id Cours</label>
                                    </div> 
                                    <div class="field-box">
                                        <input type="text" name="Note" value="<?= $data['Note']?>" maxlenght="6" pattern="[0-9.]{1,7}" title="Caractere acceptes:[0-9.]" data-error="La notes est obligatoire." required="">
                                        <label>Note</label>
                                    </div>
                                    <div class="field-box">
                                        <input type="text" name="AnneeAcademique" value="<?= $data['AnneeAcademique']?>" name="AnneeAcademique" required="">
                                    ...
                                    <div class="field-box">
                                        ...
                                        <select name="Session_notes" id="Session_notes">
                                            <option value="<?= $data['Session_notes']?>">selected : <?= $data['Session_notes']?></option>
