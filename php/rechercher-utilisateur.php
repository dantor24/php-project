                                ...
                                <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                    <ul class="navbar-nav mr-auto">
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <ul class="sub-menu">
                                                <li><a href="Dossier-palmares.php">BULLETINS ET RELEVES DE NOTES</a></li>
                                            </ul>
                    ...
                    <div class="contact-from mt-30">
                        <div class="main-form pt-45">
                            <div class="data-box" id="body-form-aca">
                                <form action="Action-rechercher-utilisateur.php" method="post">
                                    <div class="col-md-6">
                                        <div class="singel-form form-group" position="center">
                                            <label for=""> Entrer l'identifiant de l'utilisateur' </label>
                                            <br></br>
                                            <input name="Id" type="text" maxlenght="10" pattern="[a-zA-Z1-9 ]{1,10}" title="Caractere acceptes:[a-zA-Z]" placeholder="identifiant" data-error="l'identifiant est obligatoire." required="required">
